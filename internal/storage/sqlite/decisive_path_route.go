...
// DECISIVE-PATH PRIMITIVE (root A, Lua structural turn). See
// This file is the storage-side source of truth for decisive-path routing.
//
...
//
// KEEP BYTE-IDENTICAL with agent/decisive_path_route.go (regex drift guard:
